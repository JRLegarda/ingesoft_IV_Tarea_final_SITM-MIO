...
Para documentar la ejecucion, registrar tiempos con distinta cantidad de workers:

```text
Archivo              Configuracion        Tiempo total    Datagramas    Velocidades    Observaciones
MiniPilot            Monolitico           ...
MiniPilot            ThreadPool N hilos    ...
MiniPilot            1 worker             ...
MiniPilot            2 workers            ...
MiniPilot            4 workers            ...
datagrams4Pilot      1 worker             ...
datagrams4Pilot      2 workers            ...
datagrams4Pilot      4+ workers           ...
```
